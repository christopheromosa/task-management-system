...
__VLS_asFunctionalElement(__VLS_intrinsicElements.nav, __VLS_intrinsicElements.nav)(__assign({ class: "bg-dark text-white p-3 sidebar" }));
...
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0(__assign({ to: "/admin/admin-dashboard" }, { class: "nav-link text-white" })));
var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign({ to: "/admin/admin-dashboard" }, { class: "nav-link text-white" })], __VLS_functionalComponentArgsRest(__VLS_1), false));
...
/** @type {[typeof __VLS_components.RouterLink, typeof __VLS_components.RouterLink, ]} */ ;
// @ts-ignore
var __VLS_5 = __VLS_asFunctionalComponent(__VLS_4, new __VLS_4(__assign({ to: "/admin/users" }, { class: "nav-link text-white" })));
var __VLS_6 = __VLS_5.apply(void 0, __spreadArray([__assign({ to: "/admin/users" }, { class: "nav-link text-white" })], __VLS_functionalComponentArgsRest(__VLS_5), false));
...
/** @type {[typeof __VLS_components.RouterLink, typeof __VLS_components.RouterLink, ]} */ ;
// @ts-ignore
var __VLS_9 = __VLS_asFunctionalComponent(__VLS_8, new __VLS_8(__assign({ to: "/admin/tasks" }, { class: "nav-link text-white" })));
var __VLS_10 = __VLS_9.apply(void 0, __spreadArray([__assign({ to: "/admin/tasks" }, { class: "nav-link text-white" })], __VLS_functionalComponentArgsRest(__VLS_9), false));
...
/** @type {[typeof __VLS_components.RouterLink, typeof __VLS_components.RouterLink, ]} */ ;
// @ts-ignore
var __VLS_13 = __VLS_asFunctionalComponent(__VLS_12, new __VLS_12(__assign({ to: "/admin/profile" }, { class: "nav-link text-white" })));
var __VLS_14 = __VLS_13.apply(void 0, __spreadArray([__assign({ to: "/admin/profile" }, { class: "nav-link text-white" })], __VLS_functionalComponentArgsRest(__VLS_13), false));
